      ...
      <div class="btn-block">
        <div class="dropdown">
          ...
          <ul
            ...
            aria-labelledby="dropdownMenuExportLink"
          >
            <li>
              <a
                class="dropdown-item"
          ...
          <form>
            ...
            <div class="form-floating mb-3" v-for="column in newProductData">
              <input
                ...
                name="floatingInput2"
                :class="column.error ? 'input-error' : ''"
              />
          ...
          <form>
            ...
            <div class="btn-row modal-btn-row">
              ...
              <button
                type="button"
                class="btn btn-primary btn-lg"
                data-bs-target="#categoryAddedModal"
                data-bs-toggle="modal"
                data-bs-dismiss="modal"
                @click="addCategory()"
              >
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div
              ...
              v-if="newColumnType == 2 && newFormatType > 0"
            >
              <input
                type="email"
                class="form-control"
                id="floatingInput1"
                placeholder=""
                v-model.trim="newFormat"
              />
              <label for="floatingInput1">Format</label>
            </div>
            <div
              class="form-floating mb-3"
              v-if="newColumnType == 2 && newFormatType == 2"
            >
              <input
                type="email"
                class="form-control"
            ...
            <div class="mb-28">
              <div
                class="checkbox-row mb-3"
                :class="newColumnMandatory ? 'checked-row' : ''"
              >
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="btn-row modal-btn-row justify-space-between">
              <a
                type="button"
                class="text-primary btn btn-link btn-lg px-0"
        ...
        <div class="modal-body">
          ...
          <form>
            <div class="form-floating mb-28">
              <select
                class="form-select"
                v-model.trim="editProduct.parentProduct"
                aria-label="Default select example"
              >
                <option v-for="product in parentProducts" :value="product.id">
                  {{ product.name }}
                </option>
              </select>
            </div>
            <div class="form-floating mb-28">
              <select
                class="form-select"
                v-model.trim="editProduct.categoryId"
                aria-label="Default select example"
              >
            ...
            <div class="form-floating mb-3">
              <input
                ...
                name="floatingInput1"
                :class="editProduct.error ? 'input-error' : ''"
              />
              <label for="floatingInput1">Name</label>
            ...
            <div class="btn-row modal-btn-row">
              ...
              <button
                type="button"
                class="btn btn-primary btn-lg"
                :class="!editProduct.name ? 'disabled' : ''"
                data-bs-target="#productAddedModal"
                @click="checkEditForm($event)"
              >
                Save
              </button>
            </div>
...
<script>
import Datatable from "./../components/ProductTreeDataTable.vue";
...
export default {
  name: "ProductTreePage",
  title() {
    return "Raion - Product Tree";
  },
  components: {
    Datatable,
    Sidebar,
  ...
  computed: {
    title: function() {
        return this.thirdItem.value;
    }
  },
  inject: ["executeSettings", 'baseApp', 'thirdItem'],
  created: function () {
    this.getColumns();
