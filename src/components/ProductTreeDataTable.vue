  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Tree", value: "tree", sortable: true },
      ...
      fetch(`${this.$hostname}/api/ProductTree/list`, {
        ...
        .then((response) => {
          ...
          response.products.forEach((product, index) => {
            console.log(response.presets[0].children);
            if (response.presets[0].children.length > index) {
              product.tree = response.presets[0].children[index].name;
            }
